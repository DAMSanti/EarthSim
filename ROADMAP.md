...
- [ ] **No verificado visualmente** - se construyó y compiló el grafo de nodos sin poder previsualizarlo (no hay editor de materiales en texto). Puede tener errores de composición (colores, conexiones) que solo se ven abriendo el material o probando el planeta Nanite en Play. Verificar antes de dar esto por bueno del todo.
