...
- [ ] **No verificado visualmente** - se construyó y compiló el grafo de nodos sin poder previsualizarlo (no hay editor de materiales en texto). Para probarlo hace falta colocar `TectonicPlanetActor` (no `NanitePlanetActor`) en el nivel.
