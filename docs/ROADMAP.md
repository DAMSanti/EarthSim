...
- [ ] Extraer los segmentos de frontera del mapa de IDs (recorrido de contorno)
- [ ] Calcular la **normal** de cada segmento
- [ ] Clasificar por velocidad relativa proyectada sobre la normal: convergente / divergente / transformante
- [ ] Distinguir subducción de orogenia por tipo de corteza de los dos lados
- [ ] Aplicar la física **solo en la banda de frontera**, no en el 28 % del planeta
- [ ] Fallas transformantes: fricción y sismicidad, sin crear ni destruir corteza
