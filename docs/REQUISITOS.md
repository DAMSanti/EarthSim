...
*Restricción medida:* debe limitarse a celdas que **tocan continente**. Sin esa restricción satura — con tiempo suficiente cualquier celda convergente supera el umbral, y bajar la tasa a la mitad no cambia nada (222 % → 220 % de área continental). El límite no era el ritmo, era la superficie afectada.
